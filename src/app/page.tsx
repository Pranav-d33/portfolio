        ...
        <section id="contact" className="scroll-reveal section-gap section-divider pt-16">
          ...
          <div className="mb-10">
            ...
            <div className="contact-values-grid">
              {[
                { icon: '◆', label: 'Impactful work', desc: 'Building things that matter beyond the codebase.' },
                { icon: '◇', label: 'Meaningful work', desc: 'Hard, unsolved challenges worth dedicating time to.' },
                { icon: '▣', label: 'Diverse team of talented folks', desc: 'Different perspectives build better systems.' },
              ].map((item) => (
                <div key={item.label} className="contact-value-card">
                  <div className="contact-value-icon">{item.icon}</div>
                  <div>
                    <div className="text-body font-medium text-t1 mb-1">{item.label}</div>
                    <div className="text-label text-t3 leading-relaxed">{item.desc}</div>
                  </div>
                </div>
              ))}
            </div>
